...
def cek_rekening(bank_code, account_number, account_name):
    ...
    try:
        ...
        print(f"[API] {bank_code} {account_number} -> HTTP {response.status_code}")
        ...
        if response.status_code == 403:
            return {"error": "Akses ditolak, cek paket subscription (403)"}
        ...
        return {"error": "Tidak bisa konek ke api.co.id — cek koneksi internet"}
        ...
        try:
            ...
            for idx, (_, row) in enumerate(df.iterrows(), 1):
                ...
                if is_valid and score >= 9:
                    ...
                    status = "CEK MANUAL"
                    ket    = "Rekening valid, bank tidak kirim nama"
                else:
                    status = "TIDAK COCOK"
